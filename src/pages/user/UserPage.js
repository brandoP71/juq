...
class UserPage extends Component {
  ...
  componentDidMount() {
    ...
    $("#YTForm").submit(function(e)
    {
      ...
      $.get("https://www.googleapis.com/youtube/v3/search?part=snippet&maxResults=1&q=" + urlTitle + "%2B" + urlArtist + "%2Baudio&type=video&videoCategoryId=10&key=" + ytApiKey, function(data) {
